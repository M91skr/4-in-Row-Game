...
const GameBoard = () => {
    ...
    useEffect(() => {
        initGame();
        //With [] we ensure that there are no conditions and only the first game is executed.
    }, []);
    const initGame = () => {
    ...
    const circleClicked = (id) => {
        ...
        //Prevent reselection of circle
        if (gameBoard[id] !== NO_PLAYER) return;

        //Prevent the game from continuing after win
